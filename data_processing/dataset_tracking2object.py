...
def create_train_sample_data(
    input_root, output_root, operation, init_or_clear_dirs=True, only_labels=False
):
...
def create_test_sample_data(
    input_root, output_root, operation, init_or_clear_dirs=True
):
