...
def main():
    ...
    original_label_dir = Path('F://Github/3D-Multi-Object-Tracker/evaluation/results/virconv/data')
    ...
    my_label_dir = Path(f'F://Github/3D-Multi-Object-Tracker/evaluation/results/virconv_{max_distance}/data')
