...
class AnchorHeadSingle(nn.Module):
    def __init__(self, model_cfg, input_channels, num_classes, grid_size, point_cloud_range, **kwargs):
        super().__init__()
        ...
        self.conv_cls = nn.Conv2d(
            input_channels, self.num_anchors_per_location * self.num_classes,
            kernel_size=1
        )
